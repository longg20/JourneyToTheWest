<%-- 
    ...
    Created on : Jul 9, 2020, 9:51:10 PM
    Author     : Long
--%>
...
<html>
    ...
    <body style="background-image: url(images/background.png);background-size: cover">
                ...
                <tr>
                    ...
                    <td>
                        <c:url var="downloadLink" value="MainController">
                            ...
                            <c:param name="filepath" value="${sessionScope.FILE}"/>
        ...
        <c:url var="addPropLink" value="MainController">
            <c:param name="id" value="${requestScope.ID}"/>
            <c:param name="action" value="View Prop Cart"/>
        </c:url>
        <a href="${addPropLink}" style="background-color: white">Add Props</a><br/>
        
        <c:url var="addActorLink" value="MainController">
            <c:param name="id" value="${requestScope.ID}"/>
            <c:param name="action" value="View Actor Cart"/>
        </c:url>
        <a href="${addActorLink}" style="background-color: white">Add Actors</a><br/>
