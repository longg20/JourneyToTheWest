 ...
 * @author Long
 */
public class InsertCalamityController extends HttpServlet {

    private static final String SUCCESS = "SearchCalamityController";
    private static final String INVALID = "admin/insertCalamity.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (valid) {
                ...
                if (bean.insertCalamity(calamity)) {
            ...
            log("ERROR at InsertCalamityController: " + e.getMessage());
        } finally {
