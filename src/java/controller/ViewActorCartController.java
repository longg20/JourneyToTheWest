 ...
 * @author Long
 */
public class ViewActorCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            session.setAttribute("INFO", rbean.findActorsByLikeName());
            ActorCart cart = new ActorCart(cid);
            cart.load(cbean.findActorRole());
            session.setAttribute("actorCart", cart);
        } catch (Exception e) {
            log("ERROR at ViewActorCartController: " + e.getMessage());
        } finally {
