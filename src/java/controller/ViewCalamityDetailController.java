 ...
 * @author Long
 */
public class ViewCalamityDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            session.setAttribute("FILE", calamity.getFile());
        } catch (Exception e) {
            log("ERROR at ViewCalamityDetailController: " + e.getMessage());
        } finally {
