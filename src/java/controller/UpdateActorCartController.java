 ...
 * @author Long
 */
public class UpdateActorCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String description = request.getParameter("txtRoleDescription");
            String descriptionNew = request.getParameter("txtRoleDescriptionNew");
            String key = (aid + roleName).toLowerCase();
            HttpSession session = request.getSession();
            ActorCart cart = (ActorCart) session.getAttribute("actorCart");
            cart.updateDescription(key, descriptionNew);
