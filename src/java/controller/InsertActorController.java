 ...
 * @author Long
 */
public class InsertActorController extends HttpServlet {

    private static final String SUCCESS = "SearchActorController";
    private static final String INVALID = "admin/insertActor.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at InsertActorController: " + e.getMessage());
        } finally {
