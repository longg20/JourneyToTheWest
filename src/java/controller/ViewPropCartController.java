 ...
 * @author Long
 */
public class ViewPropCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            session.setAttribute("INFO", pbean.findPropsByLikeName());
            PropCart cart = new PropCart(cid);
            cart.load(cbean.findPropsUsed());
            session.setAttribute("propCart", cart);
        } catch (Exception e) {
            log("ERROR at AddPropController: " + e.getMessage());
        } finally {
